...
## NOTES OF THE AUTHOR OF THIS EXERCISE

1. This exercise has been done for a synchronous infrastructure, which expects to show the result in a command line interface immediately.
2. Also, we can use event_sourcing/event driven architectures as asynchronous alternatives, with Roda, Rack...etc.
3. you can see a video of an exercise with event_sourcing with ruby/eventide in my youtube channel. https://youtu.be/5wRJt9E0oso
4. This image represents the flow on how i understand we need to test any app:

![alt text](./how-to-test.png)